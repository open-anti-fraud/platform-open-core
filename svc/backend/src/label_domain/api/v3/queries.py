...
from label_domain.api.v3.types import ProfileGroupsCollection, label_map
...
resolve_profile_groups = paginated_field_generator(resolve_profile_groups_raw)


@strawberry.type
class Query:
    profile_groups: ProfileGroupsCollection = strawberry.field(
        permission_classes=[IsHaveAccessUpd],
