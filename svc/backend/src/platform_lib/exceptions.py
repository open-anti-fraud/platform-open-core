...
class CodedException(Exception):
    exception_messages = {
        ...
        "bad_input_data": {
            "0x3bc7c4af": "Wrong profile info fields",
            "0xf1e94dca": "Sample already belongs to another person",
            "0x2316d4c5": "Invalid profile fields",
            "0x87b68438": "One of the parameters sampleData or sampleId is required",
            "0x4694e6ef": "One of the parameters image or base64_img or sample_id is required",
            "0x963fb254": "One of the parameters sourceSampleData or sourceSampleId or sourceImage is required",
            "0x47255975": "One of the parameters upload image or base64 is required",
            ...
            "0x27b1fbb5": "One of the parameters sourceImage or sourceImageBase64 is required",
            "0x6a7905d3": "One of the parameters targetImage or targetImageBase64 is required",
            ...
            "0x42a331a0": "Fields _image and id is required",
            "0x819f9416": "Fields _image, template, age and gender is required in input sample",
            ...
            "0xc335c6b9": "Wrong sample image data",
            "0xa01dec6e": "No templates found or more than one template found",
            "0xd5e91ac0": "One of the parameters custom_input or sample_id is required",
            "0x98c7b2e5": "Scope does not exist",
            "0x28c06517": "Profiles per query limit exceeded",
        },
        "balance": {
        ...
        "internal": {
            ...
            "0x99aa11cc": "Unable to perform search. Error: {}",
            "0x68b2764e": "Unable to perform index initialization. Error: {}",
            "0x88c7e25d": "Unable to perform index synchronization. Error: {}",
            "0xefa1b0b9": "Unable to create a work queue. Error: {}",
        },
        "other": {
